...
Player:: Player(int gender,float x,float y,float w,float h){
    ...
    if(gender==0){
        ...
        pic[3] = al_load_bitmap("resources/images/play/player_boy2.png");
        pic[2] = al_load_bitmap("resources/images/play/player_boy3.png");
    }
    else{
        pic[0] = al_load_bitmap("resources/images/play/player_girl0.png");
        pic[1] = al_load_bitmap("resources/images/play/player_girl1.png");
        pic[3] = al_load_bitmap("resources/images/play/player_girl2.png");
        pic[2] = al_load_bitmap("resources/images/play/player_girl3.png");
    }
